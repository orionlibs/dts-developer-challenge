...
public class CaseController {
  ...
  private static final String GENERIC_ERROR_MESSAGE = "Unexpected error. Please contact the webmaster";
  @Autowired
  ...
  public ResponseEntity<CaseDTO> getExampleCase() {
    try {
      ...
      return ResponseEntity.badRequest().body(
          new CaseDTO(-1, null, null, null, null, null, null, null, GENERIC_ERROR_MESSAGE));
    }
  }
  ...
  public ResponseEntity<CasesDTO> getAllCases() {
    try {
      ...
      return ok(new CasesDTO(caseToReturn, null));
    } catch (Throwable e) {
      return ResponseEntity.badRequest().body(new CasesDTO(null, GENERIC_ERROR_MESSAGE));
    }
  }
  ...
  public ResponseEntity<CaseDTO> createCase(@Valid @RequestBody NewCaseDTO caseToCreate) {
    try {
      ...
      try {
        ...
        return created(
            URI.create(ControllerUtils.baseAPIPath + "/cases/" + newCase.getId())).build();
      } catch (DuplicateCaseNumberException e) {
        return ResponseEntity.badRequest().body(
            new CaseDTO(-1, null, null, null, null, null, null, null,
  ...
  public ResponseEntity<CaseDTO> updateCaseStatus(@PathVariable Integer caseID,
  ...
  @Operation(
      summary = "Updates the title of a case",
      description = "Updates the title of a case",
      requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
          required = true,
          content = @Content(
              schema = @Schema(implementation = CaseTitle.class)
          )
      ),
      responses = {
          @ApiResponse(responseCode = "200", description = "Case title updated"),
          @ApiResponse(responseCode = "404", description = "Case not found")
      }
  )
  @PatchMapping(value = "/{caseID}/titles", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<CaseDTO> updateCaseTitle(@PathVariable Integer caseID,
      @Valid @RequestBody CaseTitle title) {
    try {
      try {
        caseService.updateTitle(caseID, title);
        return ResponseEntity.noContent().build();
      } catch (CaseNotFoundException e) {
        return ResponseEntity.notFound().build();
      }
  ...
  @Operation(
      summary = "Updates the description of a case",
      description = "Updates the description of a case",
      requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
          required = true,
          content = @Content(
              schema = @Schema(implementation = CaseDescription.class)
          )
      ),
      responses = {
          @ApiResponse(responseCode = "200", description = "Case description updated"),
          @ApiResponse(responseCode = "404", description = "Case not found")
      }
  )
  @PatchMapping(value = "/{caseID}/descriptions", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<CaseDTO> updateCaseDescription(@PathVariable Integer caseID,
      @Valid @RequestBody CaseDescription description) {
    try {
      try {
        caseService.updateDescription(caseID, description);
        return ResponseEntity.noContent().build();
      } catch (CaseNotFoundException e) {
        return ResponseEntity.notFound().build();
      }
  ...
  public ResponseEntity<CaseDTO> deleteCase(@PathVariable Integer caseID) {
    try {
